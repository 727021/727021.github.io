                        ...
                        <div class="col-4">
                            <div class="btn-toolbar float-right" role="toolbar">
                                <div class="btn-group mr-2" role="group">
                                    ...
                                    ${(repo.homepage == null || repo.homepage == "") ? `` : `<a target="_blank" data-toggle="tooltip" data-placement="top" title="Homepage" role="button" class="btn btn-success" href="${repo.homepage}"><i class="fas fa-tv"></i></a>`}
                                </div>
                            </div>
                        </div>
                    </div>
